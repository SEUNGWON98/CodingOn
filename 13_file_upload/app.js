...
//   //   originalname: 'galaxy.jpg', //원본 파일명
//   //   encoding: '7bit', //파일 엔코딩 설정
//   //   mimetype: 'image/jpeg', //파일 타입
//   //   destination: 'uploads/', //파일을 저장할 경로(폴더)
//   //   filename: '31e979999e9e5082d7f9a28bd67b5fd4', //destination에 저장된 파일명
//   //   path: 'uploads\\31e979999e9e5082d7f9a28bd67b5fd4', //업로드된 파일 전체 경로
//   //   size: 83847 //파일 크기
//   //   }
...
// app.post("/practice31", uploadDeatil.single("profile"), function (req, res) {
//   console.log(req.file);
...
// app.post(
//   "/dynamicFile",
//   uploadDeatil.single("dynamic-file"),
//   function (req, res) {
//     console.log(req.file);
//   }
// );
